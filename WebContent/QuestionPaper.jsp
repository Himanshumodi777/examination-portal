...
for (i=0;i<ARRcookies.length;i++)
{
  ...
  if (x==c_name)
    ...
    <body>
        <div id="ExamPageQuestionPaper1" style="height: 10%; width:99.5%; position: fixed; padding-top: 10px;  padding-left: 140px; padding-right:140px; ">
        <form name="QuestionPaperForm" id="QuestionPaperForm" action="RunExam" method="POST">
            <font size="5"> <b id="QuestionNoSpace"><script> getCookie("QuestionNo"); </script>. </b>
