...
<%
		...
		try
		{
			...
			PreparedStatement ps=con.prepareStatement("select * from student where id=? and dob=? and contact=?");
...
<body>
	  ...
	  <div id="content">
       ...
       <h2 align="center">Recover Password</h2>
        ...
        <h3 align="center">Your Password is : <%out.println(""+password); %></h3>
        							...
        							<h4 align="right"><a  href="studentlogin.html">Click here for login</a></h4>
	...
	<% 
			...
			<script type="text/javascript">
					function falseentry(){  
					window.location.href = "studentrecover.jsp";
